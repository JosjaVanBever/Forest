...
def calcE():
    ...
    two_mo_E = 2 * sum([two_mo[i,j,i,j] for i in occupied_orbs for j in occupied_orbs]) \
        - sum([two_mo[i,j,j,i] for i in occupied_orbs for j in occupied_orbs])
...
initialE = calcE()
print('Initial energy: %.20f' % initialE)
print('')
...
def monitor(i,j,k=-1,l=-1):
    if debug:
        ...
        print('core_energy: ' + str(core_energy))
        # currentE = calcE()
        # print('Current energy: ' + str(currentE))
        print('')
...
currentE = calcE()
print('Energy after filtering one_mo\'s: %.20f' % currentE)
print('')
...
#    core_energy += two_mo[inc1, inc1, inc1, inc1]
    ...
    for c2 in core_orbs:   # works for test example
        ...
        #two_mo[inc1, inc2, inc1, inc2] = 0
        #two_mo[inc1, inc2, inc2, inc1] = 0
        #currentE = calcE()
        #print('Energy after two_mo[c1,c2,c3,c4]: ' + str(currentE))
        # if inc2 != inc1:
        #     core_energy += two_mo[inc1, inc2, inc2, inc1]
    ...
    for a1 in active_orbs:
        for a2 in active_orbs:
            ina1 = a1 - 1
            ina2 = a2 - 1
            print('passed two_mo(%d,%d,%d,%d) = %f' % (inc1, ina1, inc1, ina2, \
                                                    two_mo[inc1, ina1, inc1, ina2]))
            one_mo[ina1, ina2] += two_mo[inc1, ina1, inc1, ina2]
            #two_mo[inc1, ina1, inc1, ina2] = 0
            #currentE = calcE()
            #print('Energy after two_mo[c1,a1,c2,a2]: ' + str(currentE))
            ...
            # # one_mo[ina1, ina2] += 2 * two_mo[inc1, ina1, ina2, inc1]
            # # one_mo[ina1, ina2] -= two_mo[inc1, ina1, inc1, ina2]
            # # one_mo[ina1, ina2] -= two_mo[ina1, inc1, ina2, inc1]
...
currentE = calcE()
print('Energy after filtering two_mo\'s: %.20f' % currentE)
print('')
...
print('orbsym: ' + str(orbsym))
print('one_mo: ' + str(one_mo))
